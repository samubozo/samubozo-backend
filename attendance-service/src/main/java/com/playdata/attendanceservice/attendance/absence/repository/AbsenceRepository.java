...
public interface AbsenceRepository extends JpaRepository<Absence, Long> {
     ...
     */
    List<Absence> findByUserIdOrderByCreatedAtDesc(String userId);
     ...
     */
    List<Absence> findByUserIdAndApprovalStatusOrderByCreatedAtDesc(String userId, ApprovalStatus approvalStatus);

    /**
     * 결재자별 처리한 부재 내역을 조회합니다.
     */
    List<Absence> findByApproverIdOrderByApprovedAtDesc(String approverId);
